      ...
      */
      {
        ...
        * @param [args.success] {Function} called if all went alright. The first arguement given it the answser from the server.
        * @param [args.complete] {Function} called when request has been made, with the second argument being "success", "notmodified", "error", "timeout", "abort", or "parsererror".
        * @param [args.error] {Function} called if there was an error, with second and third argument giving more details about the error.
