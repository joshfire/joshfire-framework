...
(function(exports) {
  ...
  var CustomPlayerBuilder = Builder.extend({
    ...
    initialize: function(options) {
      ...
      this.onControlClick = options.onControlClick;
    ...
    toHtml: function(cb) {
      var html = '<div id="' + this.guid + '-events" class="js-video-mask" style="position:absolute; width:100%; height:100%">' +
          '<div class="video-controls js-video-controls" style="position:absolute; top:50%; left:50%; height: 50px; width: 50px; background:red">' +
          '</div>' +
          '<div class="video-timeline js-video-timeline" style="position:absolute; bottom:0; left:0; height:20px; width: 100%; background: rgba(100,100,100,0.5)">' +
            '<div class="video-done js-video-done" style="background-color: green; height: 4px; width: 0%; float:left; transition: width 1s; webkit-transition: width 1s;"></div>' +
            '<div class="video-undone" style="background-color: red; height: 4px; width: 100%;"></div>' +
          '</div>' +
        '</div>';
    ...
    init: function() {
      ...
      if (this.onControlClick) {
        this.onClick = _.bind(function (event) {
          this.onControlClick();
          return false;
        }, this);

        $('body').on('click', '#' + this.guid + '-events .js-video-controls', this.onClick);
      }
      return this;
    },
    ...
    exit: function() {
      if (this.initDone) {
        ...
        if (this.onClick) $('body').off("click", this.onClick);
        this.initDone = false;
      }
      return this;
    },
