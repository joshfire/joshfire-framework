...
function(Backbone, $, _) {
  ...
  window.VK_BACK_SPACE = typeof VK_BACK_SPACE !== 'undefined' ? VK_BACK_SPACE : 8;
  ...
  keyCodeToName[window.VK_BACK_SPACE] = 'back';
  ...
  _.extend(Remote.prototype, Backbone.Events, {
    ...
    onKeyPress: function(event) {
      ...
      if(typeof name !== 'undefined') {
        console.log('tv:publish event press:'+name);
    ...
    onKeyUp: function(event) {
      var name = keyCodeToName[event.keyCode];
      if(typeof name !== 'undefined') {
        console.log('tv:publish event release:'+name);
