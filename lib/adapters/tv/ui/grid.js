...
define(["joshlib!ui/list","joshlib!utils/dollar","joshlib!vendor/underscore"], function(UIList,$,_) {
  ...
  var UIGrid = UIList.extend({
    ...
    setContent: function(html) {
      if(this.$el.hasClass('nav-focused')) {
        this.savedItemFocus = this.active;
      }
      else {
        this.savedItemFocus = -1;
      }

      UIList.prototype.setContent.call(this, html);
    },

    enhance: function() {
      console.warn("enhance");
      ...
      if(typeof this.savedItemFocus !== "undefined" && this.savedItemFocus !== -1) {
        this.activate(this.savedItemFocus);
      }
    },
