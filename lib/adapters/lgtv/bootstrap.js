...
(function() {
  ...
  */
  JF = {
    ...
    * @type {Object}
    */
    adapterModules: {"android":["app","dependencies.json","inputs/touch","ui/toolbar","uielements/list","uielements/panel","uielements/video.mediaelement","vendor/iscroll"],"browser":["app","inputs/http","inputs/keyboard","inputs/mouse","uielement","uielements/list","uielements/mediacontrols","uielements/page","uielements/panel","uielements/panel.manager","uielements/video.mediaelement","uielements/video.popup","uielements/video.youtube.swf","utils/activitymonitor","utils/datasource","utils/localstorage","utils/navigation","utils/stresstest"],"clientside":[],"googletv":["dependencies.json","inputs/keyboard","ui/videoplayer","uielement"],"ios":["dependencies.json"],"lgtv":["dependencies.json","ui/videoplayer","uielement","utils/dollar"],"node":["app.factory","app","class","global.exec","inputs/http","server","uielements/page","uielements/panel","uielements/panel.manager","uielements/video.mediaelement","utils/datasource","utils/dollar","utils/eventsocket","utils/templatecompiler.cli","utils/templatecompiler","vendor/iscroll","vendor/json2","view"],"none":[],"philips":["dependencies.json","ui/videoplayer","uielement","uielements/list","uielements/video.mediaelement","utils/dollar","utils/stresstest"],"phone":["collection","ui/toolbar","uielement","utils/dollar","utils/onready"],"qt4":[],"samsungtv":["dependencies.json","inputs/remote","ui/videoplayer","uielement","uielements/map","uielements/video.mediaelement","utils/dollar","utils/navigationhelper","utils/samsungAPIs"],"serverside":[],"tv":["inputs/remote","ui/cardpanel","ui/grid","ui/horizontallayout","ui/slidepanel","ui/toolbar","ui/verticallist","ui/videoplayer","uielement"]},
...
define("joshlib",{
	normalize: function(name,normalize) {
		...
		var path = "joshlib-require/";

		//If we already passed through the plugin
		if (name.substring(0,path.length)==path) return name;
