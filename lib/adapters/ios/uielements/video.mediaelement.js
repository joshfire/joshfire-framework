  ...
  return Class(Video, {
    ...
    */
    playWithStaticUrl: function(options) {
      ...
      $('#' + self.htmlId)[0].innerHTML = '<span class="close">Close</span><video id="' + self.htmlId + '_video" src="' + options.url + '" ' + (options.noautoplay ? '' : 'autoplay="true"') + ' autobuffer preload ' + (options.image ? 'poster="' + options.image + '"' : '') + ' />';
