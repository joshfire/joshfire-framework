...
//            var strEvent = self.keyCodeToInputEvent(e.keyCode);
            self.mylog('keypress '+e.keyCode+' ; '+(e.keyCode==VK_BACK));
...
//              return false;
          ...
          document.addEventListener('keydown',function(e){
            ...
            var strEvent = self.keyCodeToInputEvent(e.keyCode);
            self.mylog('keydown '+e.keyCode+' ; '+strEvent);
            ...
            if (strEvent) {
                ...
                else if (strEvent=='easter' && document.getElementById('log')){
                    document.getElementById('log').style.display=document.getElementById('log').style.display=='block' ? 'none' :'block';
                }
                else{
