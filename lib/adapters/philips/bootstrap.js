...
(function() {
  ...
  */
  J = {
    ...
    * @type {Object}
    */
    adapterModules: {"philips": ["app", "uielement", "inputs/remote", "uielements/list", "uielements/video.mediaelement", "utils/datasource", "utils/stresstest"]},
...
(function(J) {
  ...
  J.onReady = function(f) {
    J.require(['joshfire/vendor/zepto-notouch'], function($) {
      //      $(f);
      f.call();
    });
  };
