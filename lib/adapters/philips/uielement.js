...
Joshfire.define(['../../uielement', 'joshfire/class', 'joshfire/vendor/underscore', 'joshfire/vendor/zepto-notouch'], function(UIElement, Class, _) {
...
/*
    insertInParent: function(parentElement) {
      ...
      if (!_id(this.htmlId)) {
        ...
        this.parentInnerHtmlEl.insertBefore(div, null);
...
//        this.parentInnerHtmlEl.innerHTML += this.getHtml();
      }
      this.htmlEl = _id(this.htmlId);
      this.innerHtmlEl = _id(this.innerHtmlId);
    },
