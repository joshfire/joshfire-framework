...
//          innerTemplate: '<object id="video"></object>',
    ...
    */
    ...
    self.daemon = setInterval(self.player.onPlayStateChange=self.checkPlayState, 1000);
       ...
       //  self.mylog('onPlayStateChange ' + self.player.playState+ ', '+self.videoStatus+' ['+Math.round(self.player.playPosition/1000)+' , '+Math.round(self.player.playTime/1000)+']');
                 ...
                 case 1: // playing
                  if (self.videoStatus!='loading'){
                    ...
                    self.mylog('remove loading screen')
                  }
                  break;      
                 case 2: // paused
    ...
    */
    pause: function() {
      this.mylog('PAUSE '+typeof this.player);
    ...
    */
    resume: function() {
      ...
      this.mylog('PLAY '+typeof this.player.stop);
