  ...
  return Class(Video, {
    ...
    */
    playWithStaticUrl: function(options) {
     //console.warn('play with static url');
     var self=this;
     $('#' + self.htmlId)[0].innerHTML = '<span class="close">Close</span> <object id="video" type="video/mpeg4" width="240" height="180" data="'+options.url+'" />';
