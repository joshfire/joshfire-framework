...
//          innerTemplate: '<object id="video"></object>',
    ...
    */
    ...
    self.daemon = setInterval(self.player.onPlayStateChange=function(){self.checkPlayState(self);}, 1000);
     return true;
  },
    checkPlayState:function(self){
       //  self.mylog('onPlayStateChange ' + self.player.playState+ ', '+self.videoStatus+' ['+Math.round(self.player.playPosition/1000)+' , '+Math.round(self.player.playTime/1000)+']');
                 ...
                 case 1: // playing
                  if (self.videoStatus!='loading'){
                    ...
                    self.hideScreenshot(self);
                  }
                  break;      
                 case 2: // paused
                 mylog('status paused, video status is '+self.videoStatus);
    ...
    **/
    showScreenshot:function(){
      if (this.screenshot) this.screenshot.style.display='';
    },
    /**
    ...
    */
    setCurrentTime: function(seconds) {
      this.mylog('jump to '+ seconds+' seconds');
