...
//          innerTemplate: '<object id="video"></object>',
    ...
    */
    playWithStaticUrl: function(options) {
     ...
     //play
    self.app.mylog(self.player.data);
    if (self.player.play){
      self.player.play(1);
    }
    ...
    checkPlayState:function(self){
       //  self.app.mylog('onPlayStateChange ' + self.player.playState+ ', '+self.videoStatus+' ['+Math.round(self.player.playPosition/1000)+' , '+Math.round(self.player.playTime/1000)+']');
                 ...
                 case 1: // playing
                  if (self.videoStatus!='playing'){
                    self.app.mylog('playState: playing')
                 ...
                 case 3: // connecting
                 case 4: // buffering
                  self.app.mylog('playState '+(self.player.playState==3 ? 'connecting' : 'buffering')+' ; '+self.videoStatus);
    ...
    */
    setCurrentTime: function(seconds) {
      this.app.mylog('jump to '+ seconds+' seconds');
