...
(function() {
  ...
  */
  JF = {
    ...
    * @type {Object}
    */
    adapterModules: {"android":["app","dependencies.json","inputs/touch","ui/toolbar","uielements/list","uielements/panel","uielements/video.mediaelement","vendor/iscroll"],"browser":["app","inputs/http","inputs/keyboard","inputs/mouse","uielement","uielements/list","uielements/mediacontrols","uielements/page","uielements/panel","uielements/panel.manager","uielements/video.mediaelement","uielements/video.popup","uielements/video.youtube.swf","utils/activitymonitor","utils/datasource","utils/localstorage","utils/navigation","utils/stresstest"],"googletv":["dependencies.json","inputs/keyboard","ui/videoplayer","uielement"],"ios":["dependencies.json"],"lgtv":["dependencies.json","ui/videoplayer","uielement"],"node":["app.factory","app","class","global.exec","inputs/http","uielement","uielements/page","uielements/panel","uielements/panel.manager","uielements/video.mediaelement","utils/datasource","utils/eventsocket","utils/templatecompiler.cli","utils/templatecompiler","vendor/json2"],"none":[],"philips":["app","inputs/remote","uielement","uielements/list","uielements/video.mediaelement","utils/datasource","utils/stresstest"],"phone":["collection","ui/toolbar","uielement","utils/dollar","utils/onready"],"qt4":[],"samsungtv":["app","inputs/remote","uielements/map","uielements/video.mediaelement","utils/navigationhelper"],"tv":["inputs/remote","ui/cardpanel","ui/grid","ui/horizontallayout","ui/slidepanel","ui/toolbar","ui/verticallist","uielement"]},
