 ...
 *
 * TODO: the class should derivate from Layout or from a potential Wrapper
...
define([
  ...
  var DynamicContainer = UIElement.extend({
    ...
    initialize: function (options) {
      ...
      this.viewFactory = _.bind(function (model, collection) {
    ...
    setModel: function(model, render) {
      ...
      if (model) {
        ...
        this.listenTo(model, 'change', this.render, this);
      }
    ...
    generate: function (cb) {
      ...
      if (this.view) {
        this.stopListening(this.view, 'load');
      }
