...
define(["joshlib!uielement","joshlib!ui/listitem","joshlib!ui/item","joshlib!vendor/jquery","joshlib!vendor/underscore"], function(UIElement, UIListItem, UIItem, $, _) {
  ...
  var UIList = UIElement.extend({
    ...
    setCollection: function(collection, render) {
      if(this.collection) {
        collection.unbind('change', this.update);
        collection.unbind('add', this.update);
        collection.unbind('remove', this.update);
        collection.unbind('reset', this.update);
        collection.unbind('syncstarted', this.syncStartedHandler);
        collection.unbind('syncsuccess', this.syncSuccessHandler);
        collection.unbind('syncerror', this.syncErrorHandler);
      }
      ...
      if(collection) {
        ...
        collection.bind('syncstarted', this.syncStartedHandler);
        collection.bind('syncsuccess', this.syncSuccessHandler);
        collection.bind('syncerror', this.syncErrorHandler);
      }
