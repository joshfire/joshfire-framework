...
define(["joshlib!uielement","joshlib!ui/listitem","joshlib!ui/item","joshlib!utils/dollar","joshlib!vendor/underscore", "joshlib!utils/i18n"], function(UIElement, UIListItem, UIItem, $, _, i18n) {
  ...
  var UIList = UIElement.extend({
    ...
    setCollection: function(collection, render) {
      if(this.collection) {
        ...
        this.collection.unbind('add', this.colChangedHandler, this);
      ...
      if(collection) {
        ...
        collection.bind('add', this.colChangedHandler, this);
