  ...
  var UIList = UIElement.extend({
    ...
    initialize: function (options) {
      ...
      this.loadMore = function () {
        ...
        if (!this.collection || !this.collection.hasMore) return;
    ...
    setCollection: function (collection, render) {
      ...
      if (this.collection) {
        ...
        this.listenTo(this.collection, 'load:start', this.syncStartedHandler);
        this.listenTo(this.collection, 'load', this.syncSuccessHandler);
        this.listenTo(this.collection, 'load:error', this.syncErrorHandler);
      }
