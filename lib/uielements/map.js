      ...
      */
      {
        ...
        */
        getMapOptions: function() {
          ...
          this.options.mapOptions.zoom = this.options.zoom || 6;
          this.options.mapOptions.center = this.getCoords(this.options.centerLatLng || {lat: 48.8674163, lng:2.3690762999999606}), //Default center, Joshfire HQ: 100 rue de la Folie-Méricourt Paris France
          this.options.mapOptions.mapTypeId = this.getMapTypeId(this.options.mapType || 'terrain');
