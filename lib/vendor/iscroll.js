define([],function() {
  ...
  var m = Math,
    ...
    // orientationchange disabled because it is not the only source of external
    // window resizes on mobiles (ads)
  ...
  iScroll.prototype = {
    ...
    _start: function (e) {
      ...
      //if (that.animating && that.options.onScrollEnd) that.options.onScrollEnd.call(that, e);
