  ...
  var newView = Backbone.View.extend({
    ...
    render: function() {
      ...
      this.generate(function(err, html) {
        // TODO: react on error!
        if (html !== false) {
        // Uncomment if param skip/limit are defined
          // if(currentHTML !== undefined && typeof(currentHTML) !== 'object') {
          //   var startList = html.indexOf('<ul class="list">');
          //   html = html.substr(0, startList+18) + currentHTML + html.substr(startList+18);
    ...
    enhance: function() {
      ...
      if (this.loadingClass && this.$el) {
        ...
        this.off('load', this.removeLoadingClass, this);
        this.on('load', this.removeLoadingClass, this);
      }
    },
