...
define([
  ...
  var newView = Backbone.View.extend({
     ...
     */
    wrapContent: function(innerHTML, elName) {
      innerHTML = innerHTML || '';
      ...
      if(elName) {
        outerHTML += ' data-joshfire-child="'+escapeHtml(elName)+'"';
      }
    ...
    runImageLoader: function() {
      ...
      var imageLoaded = function (imageEl) {
        ...
        if (imagesLoaded === images.length) {
          ...
          if(!self.customLoadEvent) self.trigger('load');
          else self.trigger('imagesLoad');
        }
      };
    ...
    enhance: function() {
      ...
      if (this.isLoadingNeeded() && this.$el) {
        this.showLoader();
        this.unbind('load', this.hideLoader, this);
        this.bind('load', this.hideLoader, this);
      }
      ...
      if (!this.customLoadEvent && !this.isImageLoadingNeeded()) this.trigger('load');
    },
